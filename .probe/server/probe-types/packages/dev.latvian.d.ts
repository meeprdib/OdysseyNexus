...
(levels: $NumberProvider$Type, treasure: boolean): $FunctionContainer
}
...
public "handler$edj000$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
