...
public "handler$edc000$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
...
(banner: string, reason: string, expiresInMillis: long): void
}
