...
import {$MatrixStackAccessor, $MatrixStackAccessor$Type} from "packages/com/redpxnda/nucleus/mixin/client/$MatrixStackAccessor"
...
export class $PoseStack implements $IForgePoseStack, $CachingPoseStack, $PoseStackAccessor, $TransformStack, $MatrixStackAccessor {
...
export class $BufferBuilder extends $DefaultedVertexConsumer implements $BufferVertexConsumer, $BlockSensitiveBufferBuilder, $ExtendingBufferBuilder, $IrisExtendedBufferBuilder, $MemoryTrackingBuffer, $BufferBuilderExtension, $BufferBuilderAccessor, $ExtendedBufferBuilder, $VertexBufferWriter, $BufferBuilderExt {
 "format": $VertexFormat
...
public "localvar$bjh000$vertex"(alpha: float): float
