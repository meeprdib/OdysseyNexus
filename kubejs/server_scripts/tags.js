...
ServerEvents.tags('item', event => {
    ...
    event.add('on:small_mushroom', ['spelunkery:button_mushroom', 'minecraft:brown_mushroom', 'minecraft:red_mushroom', 'minecraft:crimson_fungus', 'minecraft:warped_fungus', 'spelunkery:conk_fungus', 'spelunkery:inkcap_mushroom', 'spelunkery:white_inkcap_mushroom', 'spelunkery:phosphor_fungus', 'farmersdelight:red_mushroom_colony', 'regions_unexplored:blue_bioshroom', 'regions_unexplored:green_bioshroom', 'regions_unexplored:pink_bioshroom', 'regions_unexplored:yellow_bioshroom', 'quark:glow_shroom', 'regions_unexplored:tall_yellow_bioshroom', 'regions_unexplored:tall_pink_bioshroom', 'regions_unexplored:tall_green_bioshroom', 'regions_unexplored:tall_blue_bioshroom', 'spelunkery:mushgloom', 'mynethersdelight:warped_fungus_colony'])
