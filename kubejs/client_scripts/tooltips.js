ItemEvents.tooltip(event => {
    ...
    event.add(['irons_spellbooks:arcane_debris', 'irons_spellbooks:ancient_knowledge_fragment'], 'Useless in the modpack as of now, but there might be a use for this later. If I decide to remove it, you have gotten yourself a collectors item!');
    ...
    event.add(['irons_spellbooks:inscription_table', 'irons_spellbooks:scroll_forge'], 'This item has had its functionality removed in this modpack, it only serves decorative purposes now!')
})
